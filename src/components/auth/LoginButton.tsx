...
export const LoginButton = ({ 
  ...
  const getVariantStyles = () => {
    switch (variant) {
      ...
      case 'outline':
        return 'bg-white hover:bg-gray-50 text-gray-900 border border-gray-300 shadow-sm hover:shadow-md'
      default:
        return 'bg-white hover:bg-gray-50 text-gray-900 border border-gray-300 shadow-sm hover:shadow-md'
    }
  }
    ...
    >
      {isLoading ? (
        ...
        <div className="flex items-center space-x-3">
          {/* Google "G" Icon with official colors */}
